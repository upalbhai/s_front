    ...
    <section className="max-w-7xl mx-auto px-4 py-8 md:py-12">
      <div className="flex items-center justify-between mb-10">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-foreground/[0.05] flex items-center justify-center text-foreground">
            <Sparkles size={24} />
          </div>
          <div>
            <p className="text-[10px] font-black uppercase tracking-widest text-foreground/50 mb-1">{t('home.new_additions.badge')}</p>
            <h2 className="text-2xl md:text-3xl font-black tracking-tight text-foreground">New Soundboards</h2>
          </div>
        </div>
        <Link href={lp('/new')} className="flex items-center gap-1 font-bold text-sm text-foreground/60 hover:text-foreground transition-colors group">
