  ...
  return (
    <section className="max-w-7xl mx-auto px-4 border-t border-slate-100 dark:border-slate-900">
      <div className="flex flex-col items-center text-center space-y-3 mb-10 md:mb-16">
        ...
        <h2 className="text-2xl md:text-4xl font-black tracking-tight text-foreground">{t('home.testimonials.title')}</h2>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        {TESTIMONIALS.map((t, idx) => (
          <div key={idx} className="p-5 md:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/30 flex flex-col justify-between space-y-4 md:space-y-6">
