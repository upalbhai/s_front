    ...
    <div className="container" style={{ padding: '4rem 0', maxWidth: '800px' }}>
      ...
      <div className="glass-card" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        <p style={{ color: 'var(--text-muted)' }}>
          Sound Buttons Max respects the intellectual property rights of others. If you believe that any content on our site infringes your copyright, please follow our takedown procedure.
        </p>
        <section>
          <h2>Submit a Takedown Request</h2>
          <p style={{ color: 'var(--text-muted)', marginTop: '1rem' }}>
            Please email dmca@soundbuttonsmax.com with the following information:
          </p>
