  ...
  return (
    <div className="container" style={{ padding: '4rem 0' }}>
      <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
        ...
        <p style={{ color: 'var(--text-muted)' }}>Get in touch with the {config.siteName} team.</p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '4rem' }}>
        <div className="contact-info">
          <div className="glass-card" style={{ padding: '2rem', marginBottom: '1.5rem' }}>
            ...
            <h3>Email</h3>
            <p style={{ color: 'var(--text-muted)' }}>{config.contactEmail}</p>
          </div>
          <div className="glass-card" style={{ padding: '2rem', marginBottom: '1.5rem' }}>
        ...
        <div className="glass-card" style={{ padding: '3rem' }}>
          {status === 'success' ? (
            <div style={{ textAlign: 'center', padding: '2rem' }}>
              ...
              <button onClick={() => setStatus('')} className="btn-primary" style={{ marginTop: '2rem' }}>
                Send Another
              </button>
            </div>
          ) : (
