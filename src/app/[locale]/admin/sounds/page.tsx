...
export default function AdminSoundsPage() {
  ...
  const columns: ColumnDef<AdminSound>[] = [
    ...
    },
    {
      ...
      render: (sound) => (
        <div className="flex items-center gap-1.5 text-sm font-bold text-slate-500 dark:text-slate-400">
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-purple-500"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>
          <span className="text-foreground font-black">{sound.downloadCount?.toLocaleString() || '0'}</span>
        </div>
      )
    },
    {
