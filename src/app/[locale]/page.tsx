...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      'en': 'https://soundboardmax.net/',
      'es': 'https://soundboardmax.net/es/',
      'fr': 'https://soundboardmax.net/fr/',
      'pt': 'https://soundboardmax.net/pt/',
      'ru': 'https://soundboardmax.net/ru/',
      'it': 'https://soundboardmax.net/it/',
      'ja': 'https://soundboardmax.net/ja/',
      'ko': 'https://soundboardmax.net/ko/',
      'de': 'https://soundboardmax.net/de/',
      'x-default': 'https://soundboardmax.net/',
    },
  },
