...
export default function AdminLoginPage() {
  ...
  return (
    <div className="w-full max-w-[880px] mx-auto grid grid-cols-1 md:grid-cols-[1fr_420px] gap-6 items-stretch transition-colors duration-300">
      {/* Copy Panel */}
      <div className={`p-8 rounded-3xl border backdrop-blur-2xl flex flex-col justify-center transition-colors duration-300 ${
        isDark 
          ? 'border-zinc-800 bg-zinc-900/60 text-white' 
          : 'border-zinc-200 bg-white/80 text-zinc-900 shadow-xl shadow-zinc-200/40'
      }`}>
        <div className={`inline-flex items-center gap-2 w-fit px-3 py-1.5 rounded-full border text-sm font-black uppercase tracking-wider transition-colors duration-300 ${
          isDark 
        ...
        <p className={`leading-relaxed max-w-[48ch] font-medium ${
      ...
      <form 
        ...
        className={`p-8 rounded-3xl border backdrop-blur-2xl flex flex-col justify-center gap-5 transition-colors duration-300 ${
          isDark 
            ? 'border-zinc-800 bg-zinc-900/60 text-white' 
            : 'border-zinc-200 bg-white/80 text-zinc-900 shadow-xl shadow-zinc-200/40'
        }`}
      >
        ...
        <button
          type="submit"
          disabled={loading}
          className={`mt-2 flex items-center justify-center gap-2 w-full px-6 py-4 rounded-xl font-black uppercase tracking-widest text-xs transition-all active:scale-[0.98] disabled:opacity-60 shadow-lg ${
            isDark 
        ...
        <p className={`text-[10px] text-center font-bold mt-1 uppercase tracking-widest ${
